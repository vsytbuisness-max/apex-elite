    ...
    <div className="min-h-screen pt-32 pb-24 bg-[#111111]">
      <div className="max-w-7xl mx-auto px-6 mb-16 text-center">
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <h1 className="font-heading text-5xl md:text-7xl font-bold mb-6 tracking-tight">Our Masterpieces.</h1>
          <p className="text-secondary max-w-2xl mx-auto text-lg">
            Explore our curated gallery of custom home builds, luxury kitchen renovations, and architectural bathroom designs.
          </p>
        </div>
      </div>
